...
public class CMYKActivity extends Activity {
    private TextView _indicatorTextView;
    private View _okButton;
    private ColorBarView _cyanColorBarView;
    private ColorBarView _magentaColorBarView;
    private ColorBarView _yellowColorBarView;
    private ColorBarView _keyColorBarView;
    ...
    private void assignWidget() {
        ...
        _cyanColorBarView = ( ColorBarView ) findViewById( R.id.cyanColorBarView );
        _magentaColorBarView = ( ColorBarView ) findViewById( R.id.magentaColorBarView );
        _yellowColorBarView = ( ColorBarView ) findViewById( R.id.yellowColorBarView );
        _keyColorBarView = ( ColorBarView ) findViewById( R.id.keyColorBarView );
    }
    ...
    public void onCreate( final Bundle savedInstanceState ) {
        ...
        _helper =
                new ColorBarHelper( new ColorBarView[] { _cyanColorBarView , _magentaColorBarView , _yellowColorBarView , _keyColorBarView } )
