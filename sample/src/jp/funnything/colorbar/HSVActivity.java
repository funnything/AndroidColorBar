...
public class HSVActivity extends Activity {
    ...
    private ColorBarView _hueColorBarView;
    private ColorBarView _saturationColorBarView;
    private ColorBarView _valueColorBarView;
    ...
    private void assignWidget() {
        ...
        _hueColorBarView = ( ColorBarView ) findViewById( R.id.hueColorBarView );
        _saturationColorBarView = ( ColorBarView ) findViewById( R.id.saturationColorBarView );
        _valueColorBarView = ( ColorBarView ) findViewById( R.id.valueColorBarView );
    }
    ...
    public void onCreate( final Bundle savedInstanceState ) {
        ...
        _helper =
                new ColorBarHelper( new ColorBarView[] { _hueColorBarView , _saturationColorBarView , _valueColorBarView } )
